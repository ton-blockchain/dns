...
const INDEX_LOCALES = {
	ru: {
		...
		payment_subheader_3: 'транзакицию',
		...
		payment_failure_rejection_header: 'Вы отклонили транзакцию',
		...
		payment_failure_rejection_description: 'Пожалуйста перезагрузите страницу и попробуйте еще раз',
	...
	en: {
		...
		payment_success_header: 'Placed bid successfully',
