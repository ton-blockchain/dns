...
const INDEX_LOCALES = {
	ru: {
		...
		wallet_modal_first_description: 'Выбирите кошелёк из списка ниже.',
		wallet_modal_first_footer: 'У вас нет кошелька?',
		wallet_modal_first_setup: 'Установите кошелёк',
		wallet_modal_second_title: 'Подключить кошелёк',
	...
	en: {
		...
		wallet_modal_first_description: 'Select a crypto wallet from the list below.',
		wallet_modal_first_footer: 'Don\'t have a crypto wallet?',
		wallet_modal_first_setup: 'Set up wallet',
		wallet_modal_second_title: 'Connect wallet',
